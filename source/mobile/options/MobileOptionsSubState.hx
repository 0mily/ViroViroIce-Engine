...
class MobileOptionsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		option = new Option('Use V-Slice Controls', 'If checked, the v-slice mobile controls will be used instead of the hitbox.',
			'vsliceControls', BOOL);
		addOption(option);
		...
		#if android
		option = new Option('Storage Type', 'Which folder the engine should use?', 'storageType', STRING,storageTypes);
		addOption(option);
		#end
