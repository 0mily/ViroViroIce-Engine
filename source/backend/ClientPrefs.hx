...
// ======================[Misc.]
	...
	public var showFPS:Bool = true; // change to showDEBUG pls - Mily
...
// ======================[Unused or just fucked up]
	...
	public var opponentStrums:Bool = true; // prob not making this an option on Options? It's quite useless.
	public var timeBarType:String = 'Time Elapsed';
	public var screenshotKey:Dynamic = {keyboard: 'F3', gamepad: 'NONE'}; // lets just make this public var a key on controls? - Mily

// ======================[MODIFIERS]

	public var gameplaySettings:Map<String, Dynamic> = [
		'scrollspeed' => 1.0,
		'scrolltype' => 'multiplicative', // whatever you say, Kade! We love you! - Mily
		'songspeed' => 1.0,
		'healthgain' => 1.0,
		'healthloss' => 1.0,
		'instakill' => false,
