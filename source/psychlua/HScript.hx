...
class HScript extends Iris {
	...
	override function preset() {
		...
		set('setObjectBackdrop', TileFunctions.setTileObject);
		set('setBackdrop', TileFunctions.setTileObject);
		set('makeObjectBackdrop', TileFunctions.makeTileObject);
		set('makeBackdrop', TileFunctions.makeTileObject);
		set('makeAnimatedObjectBackdrop', TileFunctions.makeAnimatedTileObject);
		set('makeAnimatedBackdrop', TileFunctions.makeAnimatedTileObject);
		set('copyObjectBackdrop', TileFunctions.copyTileObject);
		set('setBackdropVelocity', TileFunctions.setTileVelocity);
		set('setBackdropMotion', TileFunctions.setTileMotion);
		set('setBackdropAxes', TileFunctions.setTileAxes);
		set('removeObjectBackdrop', TileFunctions.removeTileObject);
