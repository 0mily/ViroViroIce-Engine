ViroViroIce's contents/ folder.

If you're a beginner, we recommend you extract contentsTemplate.zip to get started on developing your mod.
...
said edited files *must* be put in contents/images, the engine will handle the rest.
